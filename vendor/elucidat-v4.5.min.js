...
/* jQuery UI Touch Punch 0.2.2 - Copyright 2011, Dave Furfero - Licensed MIT */
...
/* json2.js - 2012-10-08 - Public Domain - http://www.JSON.org/js.html */
...
Scorm.prototype.SetLocation=function(a){if("2004"==this.mode)return this.SetValue("cmi.location",a);if("1.2"==this.mode)return this.SetValue("cmi.core.lesson_location",a)};Scorm.prototype.GetExit=function(){if("2004"==this.mode)return this.GetValue("cmi.exit");if("1.2"==this.mode)return this.GetValue("cmi.core.exit")};Scorm.prototype.SetExit=function(a){if("2004"==this.mode)return this.SetValue("cmi.exit",a);if("1.2"==this.mode)return this.SetValue("cmi.core.exit",a)};
Scorm.prototype.GetSuspendData=function(){return this.GetValue("cmi.suspend_data")};Scorm.prototype.SetSuspendData=function(a){this.SetValue("cmi.suspend_data",a);this.Commit()};Scorm.prototype.GetProgress=function(){if("2004"==this.mode)return this.GetValue("cmi.progress_measure")};Scorm.prototype.SetProgress=function(a){if("2004"==this.mode)return this.SetValue("cmi.progress_measure",a)};
Scorm.prototype.GetCompletionThreshold=function(){return"2004"==this.mode?this.GetValue("cmi.completion_threshold"):!1};Scorm.prototype.SetCompletionThreshold=function(a){"2004"==this.mode&&this.SetValue("cmi.completion_threshold",a)};Scorm.prototype.GetScoreThreshold=function(){return"2004"==this.mode?this.GetValue("cmi.progress_measure"):!1};Scorm.prototype.SetScoreThreshold=function(a){"2004"==this.mode&&this.SetValue("cmi.scaled_passing_score",a)};
Scorm.prototype.SetSessionTime=function(a){a||(a=(new Date).getTime()-this.start_time);if("2004"==this.mode)return this.SetValue("cmi.session_time",this._format_time(a),!0);if("1.2"==this.mode)return this.SetValue("cmi.core.session_time",this._format_time(a),!0)};Scorm.prototype.GetTotalTime=function(){return"2004"==this.mode?this.GetValue("cmi.total_time"):"1.2"==this.mode?this.GetValue("cmi.core.total_time"):!1};
Scorm.prototype.GetCompletionStatus=function(){if("2004"==this.mode)return this.GetValue("cmi.completion_status");if("1.2"==this.mode){var a=this.GetValue("cmi.core.lesson_status");return"passed"==a||"failed"==a?"completed":a}};Scorm.prototype.SetCompletionStatus=function(a){"2004"==this.mode?this.SetValue("cmi.completion_status",a):"1.2"==this.mode&&this.SetValue("cmi.core.lesson_status",a);this.Commit()};
Scorm.prototype.GetResult=function(){if("2004"==this.mode)return this.GetValue("cmi.success_status");if("1.2"==this.mode){var a=this.GetValue("cmi.core.lesson_status");return"passed"==a||"failed"==a?a:"unknown"}};Scorm.prototype.SetResult=function(a){"2004"==this.mode?"passed"==a?this.SetValue("cmi.success_status","passed"):"failed"==a&&this.SetValue("cmi.success_status","failed"):"1.2"==this.mode&&("passed"==a?this.SetCompletionStatus("passed"):"failed"==a&&this.SetCompletionStatus("failed"));this.Commit()};
Scorm.prototype.SetPassed=function(){this.SetResult("passed")};Scorm.prototype.SetFailed=function(){this.SetResult("failed")};Scorm.prototype.SetCompleted=function(){this.SetCompletionStatus("completed")};Scorm.prototype.SetIncomplete=function(){this.SetCompletionStatus("incomplete")};
Scorm.prototype.SetScore=function(a,b,c){this.has_score=!0;"2004"==this.mode?(this.SetValue("cmi.score.raw",a),this.SetValue("cmi.score.scaled",1/c*a),this.SetValue("cmi.score.min",b),this.SetValue("cmi.score.max",c)):"1.2"==this.mode&&(this.SetValue("cmi.core.score.raw",a),this.SetValue("cmi.core.score.min",b),this.SetValue("cmi.core.score.max",c));this.Commit()};
Scorm.prototype.SetObjective=function(a,b,c,d,g,k){var f=this.objectives.indexOf(a);-1==f&&(f=this.objectives.length,this.SetValue("cmi.objectives."+f+".id",a),"2004"==this.mode&&this.SetValue("cmi.objectives."+f+".description",k),this.objectives.push(a),this.SetValue("cmi.objectives."+f+".score.min",d?d:0),this.SetValue("cmi.objectives."+f+".score.max",g?g:100));this.SetValue("cmi.objectives."+f+".score.raw",c?c:0);"2004"==this.mode?(this.SetValue("cmi.objectives."+f+".completion_status","completed"),
...
Scorm.prototype.SetInteraction=function(a,b,c,d,g,k,f,l){var e=this.interactions.indexOf(a),h="1.2"==this.mode?!0:!1;-1==e&&(e=this.interactions.length,this.SetValue("cmi.interactions."+e+".id",a,h),this.SetValue("cmi.interactions."+e+".objectives.0.id",b,h),"2004"==this.mode&&(this.SetValue("cmi.interactions."+e+".description",g),this.SetValue("cmi.interactions."+e+".type",k)),this.interactions.push(a));d&&("2004"==this.mode?k&&f&&(this.SetValue("cmi.interactions."+e+".learner_response",d),this.GetValue("cmi.interactions."+
e+".learner_response")!=d&&(this.SetValue("cmi.interactions."+e+".learner_response","elucidaterror"),this.SetValue("cmi.interactions."+e+".learner_response",d),this.GetValue("cmi.interactions."+e+".learner_response")!=d&&(a=d.split("[,]").join("__"),this.SetValue("cmi.interactions."+e+".learner_response",a))),this.SetValue("cmi.interactions."+e+".correct_responses.0.pattern",f),this.SetValue("cmi.interactions."+e+".weighting",l)):this.SetValue("cmi.interactions."+e+".student_response",d,h));"neutral"==
c?this.SetValue("cmi.interactions."+e+".result","neutral",h):"passed"==c||"completed"==c?this.SetValue("cmi.interactions."+e+".result","correct",h):"failed"==c&&("2004"==this.mode?this.SetValue("cmi.interactions."+e+".result","incorrect"):this.SetValue("cmi.interactions."+e+".result","wrong",h))};
...
(function(){for(var a=function(){var a=[],b;var c=window.navigator.userAgent;b={version:0,actingVersion:0,isIE:!1,compatibilityMode:!1};var d=c.match(/Trident\/(\d+)/);d&&(b.isIE=!0,b.version=parseInt(d[1],10)+4);if(d=c.match(/MSIE (\d+)/))b.isIE=!0,b.actingVersion=parseInt(d[1]);if(c=c.match(/Edge\/(\d+)/))b.isIE=!0,b.version=parseInt(c[1]);document.documentMode&&document.documentMode!=b.actingVersion&&(b.actingVersion=parseInt(document.documentMode));0==b.version&&0<b.actingVersion&&(b.version=
b.actingVersion);b.isIE?(0<b.version&&0<b.actingVersion&&(b.compatibilityMode=b.version!=b.actingVersion),!0==b.compatibilityMode&&(c=b.version,b.version=b.actingVersion,b.actingVersion=c)):b=null;if(b){switch(b.version){case 6:case 7:case 8:a.push("ie"+b.version,"ie-lt9");break;case 9:case 10:case 11:a.push("ie"+b.version);break;case 12:case 13:case 14:a.push("ie11","ie-gt11");break;default:a.push("ie"+b.version)}b.compatibilityMode&&a.push("ie-compatibility-mode","ie-compatibility-"+b.actingVersion);
return a}b="undefined"!==typeof InstallTrigger?"firefox":null;if(b)return a.push("firefox"),a;b=/opera|OPR/i.test(window.navigator.userAgent)?"opera":null;if(b)return a.push("opera"),a;if(b=/iPad/i.test(window.navigator.userAgent)?"ipad":/iPhone/i.test(window.navigator.userAgent)?"iphone":null)return a.push("ios","mobile",b),a;b=/Android/i.test(window.navigator.userAgent)?"android":null;b&&a.push("android","mobile");return a}(),b=document.documentElement,c=0,d=a.length;c<d;c++)b.className+=" "+a[c]})();
(function(){for(var a,b=function(){},c="assert clear count debug dir dirxml error exception group groupCollapsed groupEnd info log markTimeline profile profileEnd table time timeEnd timeStamp trace warn".split(" "),d=c.length,g=window.console=window.console||{};d--;)a=c[d],g[a]||(g[a]=b)})();Date.now||(Date.now=function(){return(new Date).getTime()});
var xhr2=(new XMLHttpRequest).upload&&window.FormData&&!window.XDomainRequest?!0:!1,Elucidat_CourseLoader=function(){this.elucidat=null;this.lms=new Scorm;this.lms.Initialize()};
Elucidat_CourseLoader.prototype.go=function(a){var b=this;a.project_code&&$("body").attr("id","pr_"+a.project_code+"_body");var c={loader:initialiser,homepage_url:(a.cdn?a.cdn+"/":"")+(a.current?a.current:a.homepage),lms:b.lms,history:a.history?a.history:{},answers:a.answers?a.answers:{},inputs:a.inputs?a.inputs:{},language:a.language?a.language:{},localisation:a.localisation?a.localisation:{},verbs_whitelist:a.verbs_whitelist?a.verbs_whitelist:null};a.mode&&(c.mode=a.mode);b.elucidat=new Elucidat(c,
a.activity_id,a.lrs);b.elucidat.lrs&&(a.registration&&b.elucidat.lrs.set_registration(a.registration),a.learner_name&&(b.elucidat.lrs.learner_name=a.learner_name));initialiser.resetErrorWatch("content",504);setTimeout(function(){b.elucidat&&b.elucidat.load()},250);a.registration&&"offline"!=a.mode&&b.lms.SetSuspendData(a.registration)};
Elucidat_CourseLoader.prototype.access=function(a){function b(b){c++;if(2==c)if("js"==b){var f;f=function(){window.Elucidat?d.go(a):setTimeout(function(){f()},50)};f()}else d.go(a)}var c=0,d=this;initialiser.load("link",(a.cdn?a.cdn+"/":"")+a.css,b);initialiser.load("script",(a.cdn?a.cdn+"/":"")+a.js,b)};Elucidat_CourseLoader.prototype._load_json=function(a){this.elucidat&&this.elucidat._load_json(a)};Elucidat_CourseLoader.prototype._load_navigation=function(a){this.elucidat&&this.elucidat._load_navigation(a)};
var Elucidat_MenuLoader=function(){this._lrs=this._endpoint_data=this._data=null};Elucidat_MenuLoader.prototype._load_menu=function(a){this._data=a;var b=this,c=getParams().elucidatlang;b._endpoint_data.current_project_code&&b._endpoint_data.current?b.openCourse():c?setTimeout(function(){var a=b.getLangCourse(c);-1<a?b._goto_course(a):b.createMenu()},1E3):b.createMenu()};
Elucidat_MenuLoader.prototype.getLangCourse=function(a){var b,c=-1;b=this._endpoint_data.menu&&"object"==typeof this._endpoint_data.menu?this._endpoint_data.menu:this._data.courses;c=this.checkLang(b,a,!0);-1===c&&(c=this.checkLocalisation(b,a,!0));-1===c&&(c=this.checkLang(b,a,!1));-1===c&&(c=this.checkLocalisation(b,a,!1));return c};
Elucidat_MenuLoader.prototype.checkLang=function(a,b,c){for(var d=0;d<a.length;d++){var g=a[d].language.toLowerCase();if(c){if(g===b)return d}else if(-1<b.indexOf("-")&&b.split("-")[0]===g)return d}return-1};Elucidat_MenuLoader.prototype.checkLocalisation=function(a,b,c){for(var d=0;d<a.length;d++){var g=a[d].localisation.language;for(key in g)if(key.toLowerCase(),c){if(g.hasOwnProperty(key)&&g[key]===b)return this._goto_course(d),d}else{var f=g[key];if(-1<b.indexOf("-")&&b.split("-")[0]===f)return d}}return-1};
Elucidat_MenuLoader.prototype.openCourse=function(){var a=this,b;setTimeout(function(){b=a._endpoint_data.menu&&"object"==typeof a._endpoint_data.menu?a._endpoint_data.menu:a._data.courses;for(var c=0;c<b.length;c++)b[c].project_code==a._endpoint_data.current_project_code&&a._goto_course(c)},1E3)};
Elucidat_MenuLoader.prototype.access=function(a){this._endpoint_data=a;initialiser.load("link",(a.cdn?a.cdn+"/":"")+a.css);a.menu&&"object"==typeof a.menu?this._load_menu({courses:a.menu}):initialiser.load("script",(a.cdn?a.cdn+"/":"")+a.menu)};Elucidat_MenuLoader.prototype.hideMenu=function(){$("#elucidat_menu").fadeOut(500,function(){$(this).remove()})};
Elucidat_MenuLoader.prototype.createMenu=function(){var a=this,b=$('<div id="elucidat_menu"><div id="pew"><div class="e-course-chooser-menu"><div aria-haspopup="true" tabindex="1" role="button" aria-controls="js-lang-select-menu" class="save_button button e-button-medium  js-course-button" >Select Language<span class="icon"><i class="ti chevron-down"><span class="focusHelper"></span></i></span></div><div class="course__menu"><div class="course_menu__wrap"><ul id="js-lang-select-menu" role="menu"  aria-label="Select Language"></ul></div></div></div></div></div>').hide(),c=
b.find("ul"),d=b.find(".button"),g=b.find(".e-course-chooser-menu");d.on("click",function(a){g.hasClass("open")?(g.removeClass("open"),d.attr("aria-expanded",!1)):(g.addClass("open"),d.attr("aria-expanded",!0),setTimeout(function(){h.first().focus()},150));a.preventDefault()});for(var f=0;f<a._data.courses.length;f++)c.append('<li role="none"><a class="e-language" href="#'+f+'" aria-setsize="'+a._data.courses.length+'" aria-posinset="'+(f+1)+'" title="'+a._data.courses[f].label+'" aria-label="'+a._data.courses[f].label+
'" role="menuitem" tabindex="-1">'+a._data.courses[f].label+'<span class="icon"><i class="ti chevron-right"></i></span></a></li>');$("body").append(b);var h=$("a.e-language");h.on("keyup",function(a){var b=h.index(this);switch(a.keyCode){case 38:0===b?h.last().focus():h.eq(b-1).focus();break;case 40:b===h.length-1?h.first().focus():h.eq(b+1).focus();break;case 27:g.removeClass("open");d.attr("aria-expanded",!1);d.focus();break;case 36:h.first().focus();break;case 35:h.last().focus()}});d.on("keyup",
function(a){switch(a.keyCode){case 40:case 32:case 13:d.click();break;case 38:g.hasClass("open")||d.click()}});initialiser.hideLoading();b.delay(500).fadeIn(500);b.find("a").off("click").on("click",function(b){b.preventDefault();b=$(this);b=parseInt(b.attr("href").replace("#",""));return a._goto_course(b)})};
Elucidat_MenuLoader.prototype._open_course=function(a){var b=this._data.courses[a],c;for(c in this._endpoint_data)if("menu"!=c&&(!b.hasOwnProperty(c)||"lrs"==c))b[c]=this._endpoint_data[c];endpoint=b;setTimeout(function(){e.access(b)},1E3)};
Elucidat_MenuLoader.prototype._goto_course=function(a){var b=this;b.hideMenu();setTimeout(function(){initialiser.showLoading()},500);if(window.registration_set)b._open_course(a);else var c=setInterval(function(){window.registration_set&&(clearInterval(c),b._open_course(a))},50);return!1};var Elucidat_Initialiser=function(){this.error_watch=null;this.errors={account:"<p>Sorry - there was a problem loading this course.</p>",content:"<p>Sorry - there was a problem loading this content.</p>"}};
Elucidat_Initialiser.prototype._decompress_suspend_data=function(){if(e.lms.GetSuspendData()){var a=JSON.parse(e.lms.GetSuspendData()),b={},c;for(c in a.h){if(!a.h.hasOwnProperty(c))return;var d=a.h[c];b[c]={experienced:d.e?!0:!1,visited:d.e?!0:d.v?!0:!1,parts:d.p?d.p:{}};var g={},f;for(f in b[c].parts){if(!b[c].parts.hasOwnProperty(f))return;var h=d.p[f];g[f]={score:100*h.s,answers:h.a}}b[c].parts=g}a.h=b;return a}};
Elucidat_Initialiser.prototype.init=function(a){window.registration_set=!0;!1==a.hasOwnProperty("type")&&(a.type="course");if(a.mode){if("scorm"==a.mode)a.registration=e.lms.GetSuspendData();else if("offline"==a.mode){var b=this._decompress_suspend_data();b&&(a.history=b.h,a.current="pages/"+b.c,a.registration=b.r)}if("scorm"==a.mode||"offline"==a.mode)if(b=e.lms.GetLearnerID())a.actor={mbox:"mailto:"+b,name:e.lms.GetLearnerName()};if("offline"==a.mode||"scorm"==a.mode){var c=function(b){var g={url:a.start_url,
type:"GET",dataType:"json",crossDomain:!0,timeout:5E3,data:{activityId:a.activity_id,agent:a.actor,registration:a.registration},success:function(b,c,d){a.registration=b.registration;window.registration_set=!0;"course"==a.type?"offline"==a.mode?e.elucidat&&e.elucidat.lrs&&e.elucidat.lrs.set_registration(b.registration):e.access($.extend({},a,b)):"scorm"==a.mode&&m.access($.extend({},a,b))},error:function(f){"xhr"==b&&401==parseInt(f.status)?(console.log("Error calling API, trying a different method..."),
xhr2=!1,c("jsonp")):(console.log("Error calling API, status code "+f.status+", message: "+f.responseText),window.registration_set=!0,"offline"!=a.mode&&initialiser.error("content",f.status))}};"jsonp"==b?(g.dataType="jsonp",g.data.credentials=a.start_authentication):(g.beforeSend=function(b){a.start_authentication&&b.setRequestHeader("Authorization","Basic "+a.start_authentication);b.setRequestHeader("X-Experience-API-Version","1.0.0")},g.data.agent=JSON.stringify(g.data.agent));$.ajax(g)};window.registration_set=
!1;xhr2?c("xhr"):c("jsonp")}}if(!a.mode||"offline"==a.mode||"online"==a.mode)"course"==a.type?e.access(a):m.access(a)};Elucidat_Initialiser.prototype.resetErrorWatch=function(a,b){var c=this;clearTimeout(c.error_watch);c.error_watch=setTimeout(function(){c.error(a,b)},2E4)};Elucidat_Initialiser.prototype.clearErrors=function(){clearTimeout(e.error_watch);this.error=function(){}};
Elucidat_Initialiser.prototype.error=function(a,b){this.clearErrors();var c=$("#elucidat_loading");if(c.length){var d=this.errors[a];b&&d.replace(".","("+b+").");c.find("> div:first-child").addClass("error").append(d);c.find("div.brand").remove()}};Elucidat_Initialiser.prototype.hideLoading=function(a){this.clearErrors();var b=$("#elucidat_loading");b.length&&b.fadeOut(500,function(){a&&(window.spinner&&window.spinner.stop(),$(this).remove())})};
Elucidat_Initialiser.prototype.showLoading=function(){this.clearErrors();var a=$("#elucidat_loading");a.length&&a.delay(250).fadeIn(500)};Elucidat_Initialiser.prototype.success=function(a){this.hideLoading(!0)};
Elucidat_Initialiser.prototype.load=function(a,b,c,d){d=document;var g=!1,f=d.createElement(a);d=d.getElementsByTagName(a)[0];if("link"==a){var h=$("head > link.abei");f.href=b;f.rel="stylesheet";f.className="abei"}else f.src=b;c&&("link"==a?(setTimeout(function(){h.remove()},50),c("style")):f.onload=f.onreadystatechange=function(){if(!g&&(!this.readyState||"loaded"===this.readyState||"complete"===this.readyState))g=!0,c("js"),f.onload=f.onreadystatechange=null,"link"!=a&&f.parentNode&&f.parentNode.removeChild(f)});
d.parentNode.insertBefore(f,null);return f};var initialiser=new Elucidat_Initialiser,e=new Elucidat_CourseLoader,m=new Elucidat_MenuLoader;window.onload=function(){initialiser.error_watch=setTimeout(function(){initialiser.error("account",504)},2E4);initialiser.init(endpoint)};
$(document).ready(function(){$("body").css("min-height",$(window).height()+"px");var a=Date.now(),b;window.onresize=function(){clearTimeout(b);b=setTimeout(function(){var b=Date.now();750<b-a&&(a=b,$("body").css("min-height",$(window).height()+"px"),$.isFunction(jQuery.fn.body_height)&&$("div.body_height").body_height(),$.isFunction(jQuery.fn.calc_fixed_header_size)&&$("#pew").calc_fixed_header_size(),$.isFunction(jQuery.fn.ie8poly_bg_size)&&ie8bg.updateElems().getElems().ie8poly_bg_size())},250)};
$("#ie7-warning").length&&setTimeout(function(){$("#ie7-warning").fadeOut(1500,function(){$(this).remove()})},4E3);window.bandwidth=1600;console.log("Bandwidth default:"+window.bandwidth);"offline"!==window.endpoint.mode&&setTimeout(function(){(new BWDetection).startTest(function(a){console.log("Bandwidth detected:"+a);window.bandwidth=a})},50)});
var BWDetection=function(a){this._imageURLBase=a?a:"https://cdn.elucidat.com/_bwd/";this._images=[{url:"test_image_1x1.gif",size:35,timeout:1E3},{url:"test_image_1x1.gif",size:35,timeout:1E3},{url:"test_image_512x512.jpg",size:754E3,timeout:2500},{url:"test_image_512x512.jpg",size:754E3,timeout:2500}]};
BWDetection.prototype={_imageCounter:0,_images:null,_imageURLBase:null,bandwidth:null,isLoading:!0,startTest:function(a){this._callback=a;this.bandwidth?this._complete():(this.isLoading=!0,this._loadImage())},_loadImage:function(){var a=this,b=a._imageCounter,c=a._images,d=new Image;d.onload=function(){a._imageLoadComplete()};var g=c[b];g.start=+new Date;g.expired=!1;g.timer=setTimeout(function(){g.expired=!0;g.end=+new Date;d.onload=null;a._imageLoadComplete()},g.timeout);d.src=a._imageURLBase+c[b].url+
"?"+Math.random()+"="+ +new Date;a._imageCounter++},_imageLoadComplete:function(){var a=this._imageCounter,b=this._images;0<a&&(!1==b[a-1].expired&&(b[a-1].end=+new Date),b[a-1].time=b[a-1].end-b[a-1].start,clearTimeout(b[a-1].timer));a>=b.length||0<a&&!0==b[a-1].expired?this._imagesLoaded():this._loadImage()},_imagesLoaded:function(){for(var a=this._images,b=0;b<a.length;b++)!1!==a[b].expired&&void 0==a[b].time&&(a[b].expired=!0,a[b].time=a[b].timeout);b=Math.abs(a[0].time-a[1].time);this.bandwidth=
Math.abs((a[2].size/((a[2].time-b+(a[3].time-b))/2/1E3)/1E3).toFixed(0));this._complete()},_complete:function(){self.isLoading=!1;this._callback&&this._callback(this.bandwidth)}};
function getParams(a){var b=a?a.split("?")[1]:window.location.search.slice(1);a={};if(b)for(var b=b.split("#")[0],b=b.split("&"),c=0;c<b.length;c++){var d=b[c].split("="),g=void 0,f=d[0].replace(/\[\d*\]/,function(a){g=a.slice(1,-1);return""}),d="undefined"===typeof d[1]?!0:d[1],f=f.toLowerCase(),d=d.toLowerCase();a[f]?("string"===typeof a[f]&&(a[f]=[a[f]]),"undefined"===typeof g?a[f].push(d):a[f][g]=d):a[f]=d}return a};
